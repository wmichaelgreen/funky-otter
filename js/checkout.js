...
$(function () {
  ...
  var checkoutEvents = function () {
    ...
    customMethods.each(function () {
      ...
      var paymentMethod = $("<div class='payment-method Custom'>");
      paymentMethod.attr("data-payment-name", paymentName);
      var panel = $("<div class='panel pad-20'>");
      var panelInner = $("<div class='payment-name custom-payment-name h4 bold'>");
      panelInner.attr("data-payment-name", paymentName);
      panelInner.html(paymentName);
      panel.append(panelInner);
      panel.append("<div class='payment-wrapper'></div>");
